...
// Make CRM_Dbmonitor_ExtensionUtil available.
require_once __DIR__ . '/../../dbmonitor.civix.php';
...
addExtensionToClassLoader($loader, 'de.systopia.dbmonitor');
 ...
 */
function _dbmonitor_test_civicrm_container(ContainerBuilder $container): void {
}
