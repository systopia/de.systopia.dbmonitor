 ...
 */
function dbmonitor_civicrm_xmlMenu(&$files) {
  _dbmonitor_civix_civicrm_xmlMenu($files);
}
 ...
 */
function dbmonitor_civicrm_managed(&$entities) {
  _dbmonitor_civix_civicrm_managed($entities);
}
 ...
 */
function dbmonitor_civicrm_caseTypes(&$caseTypes) {
  _dbmonitor_civix_civicrm_caseTypes($caseTypes);
}
 ...
 */
function dbmonitor_civicrm_angularModules(&$angularModules) {
  _dbmonitor_civix_civicrm_angularModules($angularModules);
}
 ...
 */
function dbmonitor_civicrm_alterSettingsFolders(&$metaDataFolders = NULL) {
  _dbmonitor_civix_civicrm_alterSettingsFolders($metaDataFolders);
}
 ...
 */
function dbmonitor_civicrm_themes(&$themes) {
  _dbmonitor_civix_civicrm_themes($themes);
}
 ...
 *
function dbmonitor_civicrm_preProcess($formName, &$form) {
